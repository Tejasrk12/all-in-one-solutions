    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center p-6">
      <div className="w-full max-w-6xl">
        <h2 className="text-2xl font-bold mb-6 text-center">
          SCSS Formatter & Minifier – Beautify & Organise Code
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          {/* Input SCSS */}
          <div>
            <label className="block mb-1 font-medium text-gray-700">Input SCSS</label>
            <textarea
          ...
          {/* Output SCSS */}
          <div>
            <label className="block mb-1 font-medium text-gray-700">Output SCSS</label>
            <textarea
